...
const isSkeleton = ref(true) //显示骨架屏
onLoad(async () => {
  await Promise.all([getHomeBannerData(), getCategoryTop()])
  isSkeleton.value = false
})

//获取数据
const CategoryTop = ref<CategoryTopType[]>()
...
<template>
  <CategorySkeleton v-if="isSkeleton" />
  <view v-else class="viewport">
    ...
    <view class="categories">
      ...
      <scroll-view class="secondary" scroll-y>
        ...
        <!-- 内容区域 -->
        <view class="panel" v-for="item in CategoryTop![CategoryActive].children" :key="item.id">
          <view class="title">
            <text class="name">{{ item.name }}</text>
