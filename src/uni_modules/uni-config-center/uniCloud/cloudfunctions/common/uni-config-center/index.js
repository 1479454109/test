...
var u = function(t) {
	...
	s["[object Float32Array]"] = s["[object Float64Array]"] = s["[object Int8Array]"] = s[
			...
			"[object Uint8ClampedArray]"] = s["[object Uint16Array]"] = s["[object Uint32Array]"] = !0, s[
		o] = s["[object Array]"] = s["[object ArrayBuffer]"] = s["[object Boolean]"] = s[
			"[object DataView]"] = s["[object Date]"] = s["[object Error]"] = s[u] = s["[object Map]"] = s[
			"[object Number]"] = s[c] = s["[object RegExp]"] = s["[object Set]"] = s["[object String]"] = s[
			"[object WeakMap]"] = !1;
	...
	function tt(t, r) {
		var e = Ot(t),
			...
			a = c.length;
		for (var f in t) !r && !F.call(t, f) || u && ("length" == f || o && ("offset" == f || "parent" ==
			f) || i && ("buffer" == f || "byteLength" == f || "byteOffset" == f) || dt(f, a)) || c.push(
			f);
		return c
	}
	...
	function ct(t) {
		return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : L && L in Object(t) ?
			function(t) {
				var r = F.call(t, L),
					e = t[L];
				try {
			...
			if (o || (o = new Z), xt(i)) ! function(t, r, e, n, o, i, u) {
				...
				if (h) {
					var p = Ot(f),
						_ = !p && At(f),
						v = !p && !_ && Ft(f);
					l = f, p || _ || v ? Ot(a) ? l = a : Ct(j = a) && mt(j) ? l = function(
							t, r) {
							var e = -1,
								n = t.length;
							r || (r = Array(n));
							...
							return t.copy(n), n
						}(f, !0)) : v ? (h = !1, d = f, y = !0 ? (g = d.buffer, b = new g
								.constructor(g.byteLength), new E(b).set(new E(g)), b) : d
							.buffer, l = new d.constructor(y, d.byteOffset, d.length)) :
						l = [] : function(t) {
							if (!Ct(t) || ct(t) != c) return !1;
							var r = D(t);
							if (null === r) return !0;
							var e = F.call(r, "constructor") && r.constructor;
							return "function" == typeof e && e instanceof e && C.call(e) ==
								I
	...
	function ht(t, r) {
		return bt(function(t, r, e) {
			return r = V(void 0 === r ? t.length - 1 : r, 0),
				function() {
					for (var n = arguments, o = -1, i = V(n.length - r, 0), u = Array(i); ++o < i;)
						u[o] = n[r + o];
					o = -1;
	...
	function _t(t, r) {
		...
		return ("string" == (n = typeof(e = r)) || "number" == n || "symbol" == n || "boolean" == n ?
			"__proto__" !== e : null === e) ? o["string" == typeof r ? "string" : "hash"] : o.map
	}
	...
	function dt(t, r) {
		var e = typeof t;
		return !!(r = null == r ? n : r) && ("number" == e || "symbol" != e && f.test(t)) && t > -1 && t %
			1 == 0 && t < r
	}
	...
	function zt(t) {
		if (!xt(t)) return !1;
		var r = ct(t);
		return r == u || "[object GeneratorFunction]" == r || "[object AsyncFunction]" == r ||
			"[object Proxy]" == r
	}
	...
	var St, It = (St = function(t, r, e) {
		...
		var e = -1,
			...
			o = n > 1 ? r[n - 1] : void 0,
			i = n > 2 ? r[2] : void 0;
		for (o = St.length > 3 && "function" == typeof o ? (n--, o) : void 0, i && function(
				t, r, e) {
				if (!xt(e)) return !1;
				var n = typeof r;
				return !!("number" == n ? mt(e) && dt(r, e.length) : "string" == n && r in
					e) && jt(e[r], t)
...
class f {
	constructor({
		...
		this.pluginId = t, this.defaultConfig = r, this.pluginConfigPath = o.default.resolve(n || __dirname, t),
			this.customMerge = e, this._config = void 0
	}
	resolve(t) {
	...
	config(t, r) {
		...
		return t ? function(t, r, e) {
			...
			const n = "string" != typeof(o = r) ? o : o.split(".").reduce(((t, r) => (r.split(/\[([^}]+)\]/g)
				.forEach((r => r && t.push(r))), t)), []);
			var o;
			let i = t;
